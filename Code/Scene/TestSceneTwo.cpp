...
void TestSceneTwo::InitScene()
{
	...
	for (int i = 0; i < 4; i++)
	{
		...
		Blocks[i]->transform->position = Vector2(90 * i + 180, 180);
...
void TestSceneTwo::UpdateScene()
{
}

void TestSceneTwo::ExitScene()
{
	charGO->Destroy();
	charGO = nullptr;
	for (int i = 0; i < 4; i++)
...
bool TestSceneTwo::LoadSceneMedia()
{
	bool success = true;
